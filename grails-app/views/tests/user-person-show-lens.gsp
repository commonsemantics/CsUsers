		...
		<div style="padding-left:10px;">
			...
			* to change the Locale add ?lang=language to the URL of this page
			...
			<g:form method="post" >
				...
				<div class="buttons">
					<span class="button">
						<g:actionSubmit class="save" action="testUsersPersonEdit" value="${message(code: 'org.commonsemantics.grails.users.profile.submit', default: 'Edit Profile')}" />
					</span>
					<span class="button">
						<g:actionSubmit class="cancel" action="testUsersPersonShow" value="${message(code: 'org.commonsemantics.grails.general.cancel', default: 'Cancel')}" />
					</span>
				</div>
			</g:form>
		</div>
